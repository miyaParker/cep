            ...
            <div className='w-[100%] max-w-[1440px] px-[20px] lg:px-[80px] xl:px-[140px] grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 mx-[140px] mx-auto'>
                ...
                <div className='grayscale hover:grayscale-0 border-2 border-t-0 lg:border-t-2 lg:border-l-0 border-gray-100 flex items-center justify-center h-[102px] md:h-[120px] lg:h-[144px] '>
                    <Image
                        ...
                        width={104}
                        height={35}
                        className='w-[81px] h-[16px] lg:h-[24px] lg:w-[120px] transition-all delay-50'
                    />
                </div>

                <div className='grayscale hover:grayscale-0 lg:rounded-tr-[4px] border-r-2 border-b-2 lg:border-2 lg:border-l-0 md:border-b-2 md:border-r-0 border-gray-100 flex items-center justify-center h-[]102px  md:h-[120px]lg:h-[144px] '>
                    <Image
