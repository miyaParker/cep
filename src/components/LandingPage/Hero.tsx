...
const Hero = () => {
    return (
        <div className='mx-auto overflow-x-hidden'>
            <div className='z-20 relative w-[100%] leading-[44px] lg:px-0 mx-auto before:absolute before:z-10 xl:before:content-[url("/hero-ellipse.svg")] 2xl:before:content-[url("/hero-ellipse-2xl.svg")] xl:before:left-[285px] 2xl:before:left-[485px] 2xl:before:top-[-128px] 3xl:before:content-[""] 2xl:before:content-[url("/hero-ellipse-2xl.svg")]'>
