...
const Numbers = () => {
    return (
        <div className='bg-black-100'>
            <div className='w-[100%] mx-auto flex flex-col max-w-[2560px] items-center lg:px-[80px] xl:px-[120px] 2xl:px-[160px] 3xl:px-[280px] 4xl:px-[420px] bg-black-100 h-max mt-[10rem] py-[64px] lg:pt-[40px]'>
