...
const AffiliateCenter = ({title, description, image, arrow}: AffiliateCentre ) => {

    return (<div className=" w-screen bg-[#0E0E10] flex-1">
            <div
                className="w-full max-w-[1440px] mx-auto px-[20px] lg:px-[80px] xl:px-[140px]">
                <div
                    ...
                    <div
                        className='relative mx-auto lg:mx-0 w-full max-w-[440px] lg:max-w-[545px] md:w-[440px] xl:w-[510px] 2xl:w-[545px]'>
                        <Image
                            src={image}
                            alt={title}
                            width={545}
