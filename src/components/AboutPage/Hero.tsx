...
const Hero = () => {
    return (
        <>
            <div
                className="mt-[80px] lg:mt-[124px] mx-auto gap-x-[40px] w-full lg:pt-0 flex flex-col lg:flex-row lg:justify-between items-center max-w-[1440px] px-[20px] lg:px-[80px] xl:px-[140px] pb-[72px]">
                <div className="w-full">
                    ...
                    <p className="mt-[20px] mb-[48px] leading-[150%] max-w-[420px] xl:max-w-[479px] mx-auto tracking-[0.5%] font-matter lg:text-[22px] text-center lg:text-left text-[#313235] opacity-90 text-[20px] lg:mx-0">
                        As the Education Practice of Co-creation Africa, we are committed to improving the quality of
                        education, by using evidence from research-backed innovative teaching methods and digital tools
