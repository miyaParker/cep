...
const Hero = () => {
    return (
        <>
            <div className='mx-auto w-full pt-[136px] lg:pt-0 flex flex-col lg:flex-row lg:justify-between max-w-[2560px] px-[20px] lg:px-[80px] xl:px-[140px] 2xl:px-[160px] 3xl:px-[280px] 4xl:px-[420px]'>
                <div>
                ...
                <Image
                    ...
                    width={584}
                    height={496}
                    className='lg:w-[584px] lg:h-[496px] mx-auto lg:mx-0 lg:mt-[264px]'
                />
            </div>
