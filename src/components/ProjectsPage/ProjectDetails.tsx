                    ...
                    <div
                        ...
                        <div
                            ...
                            {project.details.summary.map((summary: any) =>
                                <p className="mt-[20px] max-w-[521px] font-matter text-[17px] leading-[140%] tracking-[0.17px] text-[#333438]">{summary}</p>
                            )}
                            ...
                            {project.details.info?.keyPoints?.map((keyPoint: string, index: number) =>
                                <div className="flex items-start max-w-[521px]">
                            ...
                            {project.details.info?.description?.map((description: string) =>
                                <p className="mt-[20px] max-w-[521px] font-matter text-[17px] leading-[140%] tracking-[0.17px] text-[#333438]">{description}</p>
                            )}
