...
const AffiliateCenter = () => {
    return (
        <div className='bg-[#0E0E10] text-white py-[80px] mt-[80px]'>
            <div className='max-w-[1440px] gap-x-[20px] mx-auto font-neue font-bold flex flex-col items-center lg:justify-between lg:flex-row lg:px-[80px] xl:px-[140px]'>
                <div>
                ...
                <div className='relative  px-[20px] lg:px-0 max-h-[483px] mx-auto lg:mx-0'>
                    <Image
                        ...
                        width={550}
                        height={340}
                        className='w-full max-w-[440px] lg:max-w-[550px] mx-auto mx-[20px] lg:mx-0 lg:w-[440px] xl:w-[500px]'
                    />
                </div>
