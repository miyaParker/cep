...
const Objectives = () => {
    ...
    return (
        <div className='py-[80px] mt-[80px]' ref={ref} id='COE'>
            ...
            <div className="flex flex-col gap-4">
                {objectives.map((objective, index) => <div key={index}
                                                           className="pr-28 mx-auto bg-[#F2F2F3] flex items-center gap-3 py-8 pl-12 rounded-[4px] max-w-[752px] text-[#313235]">
            ...
            <div onClick={()=>{}}
                 className='cursor-pointer items-center gap-x-[16px] hidden lg:flex mt-[100px] mx-auto w-max'>
