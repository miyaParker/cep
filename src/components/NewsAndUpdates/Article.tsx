...
const Article = ({article, index}: { article: any, index: number }) => {
    const colorMap = {
        Events: 'bg-[#FBF2EA] text-[#E58A1F]',
        Community: 'bg-[#ECE8FC] text-[#5852D1]',
        'Programme Update': 'bg-[#FCEFED] text-[#DA4B34]',
    }
    return (
        <div
            ...
            <div className={`justify-items-start`}>
                ...
                <div className='flex items-center gap-x-[12px] mb-[24px] flex-wrap'>
                    <p className={`rounded-[3px] text-[17px] font-medium font-matter px-[16px] py-[8px] ${colorMap[article.category as keyof typeof colorMap]}`}>{article.category}</p>
